...
begin
  ...
  if v_pause_id is not null then
    ...
    if v_now > v_pause_deadline then
      ...
      set
        ...
        commentaire_pause_pointage = coalesce(pp.commentaire_pause_pointage, 'Pause arretee apres 1h05 sans signal du navigateur.'),
  ...
  if v_now > v_session_deadline then
    ...
    set
      ...
      commentaire_session_pointage = coalesce(s.commentaire_session_pointage, 'Session arretee apres 5 minutes sans signal du navigateur.'),
